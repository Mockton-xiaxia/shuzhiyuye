...
from app.routers import (
    ...
    system,
    trace,
    telemetry,  # 新增：IoT 时序数据
    effluent_gis,  # 新增：尾水 GIS
)
...
# 新增路由
app.include_router(telemetry.router, prefix=prefix)  # IoT 时序数据
app.include_router(effluent_gis.router, prefix=prefix)  # 尾水 GIS
